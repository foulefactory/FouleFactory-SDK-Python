...
"""
    foulefactoryapilib.controllers.csv_files_controller
...
class CsvFilesController(BaseController):
    ...
    def create_csv_files_create_csv_file(self,
                                         csvfiles,
                                         accept_language = 'fr'):
        """Does a POST request to /v1.1/csvFiles.

        Create new csv file

        Args:
            csvfiles (CsvFileWriterServiceModel): TODO: type description here.
                Example: 
        ...
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(csvfiles), username=Configuration.basic_auth_user_name, password=Configuration.basic_auth_password)
    ...
    def get_csv_files_get(self,
                          id,
                          accept_language = 'fr'):
        """Does a GET request to /v1.1/csvFiles/{id}.
