...
class CsvFilesController(BaseController):
    ...
    def create_csv_files_create_csv_file(self,
        ...
        Args:
            file (CsvFileWriterServiceModel): TODO: type description here.
                Example: 
        ...
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(file), username=Configuration.basic_auth_user_name, password=Configuration.basic_auth_password)
