...
class TaskLinesController(BaseController):
    ...
    def create_task_lines_create_task_line(self,
        ...
        Args:
            task_line (TaskLinesWriterServiceModel): TODO: type description
                here. Example: 
        ...
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(task_line), username=Configuration.basic_auth_user_name, password=Configuration.basic_auth_password)
