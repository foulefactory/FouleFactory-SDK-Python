...
"""
    foulefactoryapilib.controllers.task_answer_choices_controller
...
class TaskAnswerChoicesController(BaseController):
    ...
    def get_task_answer_choices_get(self,
                                    id,
                                    accept_language = 'fr'):
        """Does a GET request to /v1.1/taskAnswerChoices/{id}.
        ...
        _query_builder += '/v1.1/taskAnswerChoices/{id}'
